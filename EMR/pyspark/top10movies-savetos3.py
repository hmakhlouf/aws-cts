...
outputDir = "s3n://iquiz.emr/pyspark/output/top10movies-savetos3"
...
output.write.mode("overwrite").csv(outputDir, header=True)

print("SAVING THE OUTPUT TO S3. Location: " + outputDir)
